...
const VideoSection = () => {
  useEffect(() => {
    ...
    script.src = "https://scripts.converteai.net/d0d64cb2-dca3-4be6-983c-3bc700b6a1d8/players/698a536608ae119f5e0155bc/v4/player.js";
    script.async = true;
    ...
    <section className="bg-background py-4 sm:py-8 md:py-12 pb-0">
      <div className="container mx-auto px-3 sm:px-4 max-w-4xl">
        ...
        <div className="max-w-[70%] sm:max-w-full mx-auto">
          ...
          >
            <vturb-smartplayer 
              id="vid-698a536608ae119f5e0155bc" 
